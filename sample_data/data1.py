...
author2["author_id"]  = "2"
author2["name"] 	  = "King"
author2["login_name"] = "king2"
author2["github_id"]  = "stat3kk"
...
author3["author_id"]  = "3"
author3["name"] 	  = "He Man"
author3["login_name"] = "heman"
author3["password"]   = "123456"
author3["birthdate"]  = currentTime
author3["bio"]        = "He Man, MASTER OF THE UNIVERSE"
...
AR1["relationship_type"] = 1 # Author 1 is following author 2
...
for i in range(1, 5):
	...
	image["post_id"] = str(i*10)
	image["comment_id"] = str(i*100)
	image["image"] = blob
...
for i in range(1, 5):
	...
	url = {}
	url["URL_id"] = str(i)
	url["post_id"] = str(i*10)
	url["comment_id"] = str(i*100)
